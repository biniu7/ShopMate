 ...
 */
export function createIngredient(overrides?: Partial<(typeof sampleIngredients)[0]>) {
  return {
    ...sampleIngredients[0],
    ...overrides,
  };
 ...
 */
export function createShoppingList(overrides?: Partial<typeof sampleShoppingList>) {
  return {
    ...sampleShoppingList,
    ...overrides,
  };
 ...
 */
export function createShoppingListItem(overrides?: Partial<(typeof sampleShoppingListItems)[0]>) {
  return {
