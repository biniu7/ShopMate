...
Ostateczne wyniki powinny być w języku polskim i zapisane w pliku o nazwie .ai/doc/ui/{view-name}-view-implementation-plan.md. Nie uwzględniaj żadnej analizy i planowania w końcowym wyniku.
