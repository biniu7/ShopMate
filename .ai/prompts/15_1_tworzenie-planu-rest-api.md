...
Końcowy wynik powinien składać się wyłącznie z planu API w formacie markdown w języku angielskim, który zapiszesz w .ai\doc\15_api-plan.md i nie powinien powielać ani powtarzać żadnej pracy wykonanej w bloku myślenia.