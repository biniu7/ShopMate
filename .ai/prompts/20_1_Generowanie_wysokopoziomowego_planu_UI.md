...
Plan API:
<api_plan>
@.ai/doc/15_api-plan.md
</api_plan>

Session Notes:
<session_notes>
@ai/doc/19_2_Podsumowanie_sesji_planowania_architektury_UI.md
</session_notes>
...
Końcowy rezultat powinien składać się wyłącznie z architektury UI w formacie Markdown w języku polskim, którą zapiszesz w pliku .ai/doc/20_ui-plan.md. Nie powielaj ani nie powtarzaj żadnej pracy wykonanej w bloku myślenia.
