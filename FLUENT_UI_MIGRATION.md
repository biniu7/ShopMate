...
```css
--brand-600: oklch(0.62 0.19 254)  /* Primary brand color */
--brand-dark: oklch(0.72 0.18 254) /* Brand dla dark mode */
```

#### Warstwy surface (Light Mode)
```css
--neutral-98: Canvas     /* Główne tło */
--neutral-96: Card       /* Karty i panele */
--neutral-94: Elevated   /* Podniesione elementy */
--neutral-92: Subtle     /* Subtelne tła */
```

#### Soft Dark Mode (zamiast czystej czerni)
```css
--dark-16: oklch(0.18 0 0)  /* Główne tło dark */
--dark-18: oklch(0.20 0 0)  /* Karty dark */
--dark-20: oklch(0.22 0 0)  /* Elevated dark */
```

#### Status Colors
```css
--success: oklch(0.73 0.16 145)   /* Zielony */
--warning: oklch(0.88 0.14 75)    /* Żółty */
--info: oklch(0.74 0.12 230)      /* Niebieski */
--danger: oklch(0.62 0.23 29)     /* Czerwony */
```
...
```css
--radius-sm: 4px   (--radius-2)
--radius-md: 8px   (--radius)
--radius-lg: 12px  (--radius-3)
--radius-xl: 16px
```

#### Stroke Width
```css
--stroke-1: 1px    /* Subtelne ramki */
--stroke-2: 2px    /* Mocne ramki i focus */
```

#### Control Heights (Gęstość)
```css
--control-h-sm: 32px   /* Compact */
--control-h-md: 36px   /* Comfortable */
--control-h-lg: 40px   /* Spacious */
```
...
```css
--shadow-1: 0 1px 2px...   /* Minimalna elewacja */
--shadow-2: 0 2px 4px...   /* Średnia elewacja */
--shadow-4: 0 4px 8px...   /* Wysoka elewacja */
```
