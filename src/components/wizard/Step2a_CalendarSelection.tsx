...
import type { CalendarSelectionDto, MealType } from "@/types";
...
import { useCurrentWeekCalendar } from "@/components/hooks/useCurrentWeekCalendar";
    ...
    return (
      <div className="step-2a">
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            {error instanceof Error ? error.message : "Nie udało się załadować kalendarza"}
          </AlertDescription>
        </Alert>
